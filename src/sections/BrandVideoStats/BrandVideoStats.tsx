  ...
  return (
    <section className="section !pb-12 !pt-8 max-[640px]:!pb-8 max-[640px]:!pt-6">
      <div className="container">
        <div className="home-neomorph flex snap-x gap-3 overflow-x-auto rounded-[26px] bg-[#f4f5f7] p-3 max-[640px]:rounded-[20px] xl:grid xl:grid-cols-12 xl:overflow-visible xl:grid-rows-[repeat(9,minmax(0,108px))]" data-gsap="media-grid">
          <article className="relative isolate grid min-h-[360px] min-w-[86vw] snap-start overflow-hidden rounded-[18px] p-5 text-white md:min-w-[52vw] md:p-8 xl:col-span-8 xl:row-span-3 xl:min-h-0 xl:min-w-0 [&_*]:!text-white">
            ...
            <div className="grid h-full place-items-center text-center">
              <div className="max-w-[850px]">
                <div className="mb-8 text-sm font-black uppercase tracking-[0.16em] text-white/78 md:mb-14">
                  OrtoLux
                </div>
                <h2 className="m-0 text-[clamp(29px,5vw,70px)] font-black leading-[1.04]">
                  Собираем спальню, в которой легко высыпаться.
                </h2>
                <Link
                  className="mt-8 inline-flex min-h-10 items-center rounded-[9px] bg-[#ff7433] px-5 text-[14px] font-black md:mt-16 md:px-6"
                  href="/about"
                >
          ...
          <article className="relative grid min-h-[230px] min-w-[72vw] snap-start content-between overflow-hidden rounded-[18px] bg-[#ff7433] p-6 text-white md:min-w-[38vw] md:p-8 xl:col-span-4 xl:row-span-3 xl:min-h-0 xl:min-w-0 [&_*]:!text-white">
            <span
            ...
            <span
              ...
              aria-hidden="true"
            />
            <strong className="max-w-[330px] text-[clamp(40px,6vw,76px)] font-black leading-[0.9]">
              10 мин
            </strong>
          ...
          <VideoTile
            className="min-h-[210px] min-w-[72vw] snap-start md:min-w-[38vw] xl:col-span-2 xl:row-span-2 xl:col-start-1 xl:row-start-4 xl:min-h-0 xl:min-w-0"
            label="внутри"
            poster={media.fabric}
            src={processVideo}
          />
          ...
          <StatTile
            className="min-h-[210px] min-w-[72vw] snap-start md:min-w-[38vw] xl:col-span-3 xl:row-span-2 xl:col-start-3 xl:row-start-4 xl:min-h-0 xl:min-w-0"
            number="4000+"
            title="комплектов"
          ...
          <ImageTile
            className="min-h-[210px] min-w-[72vw] snap-start md:min-w-[38vw] xl:col-span-3 xl:row-span-2 xl:col-start-6 xl:row-start-4 xl:min-h-0 xl:min-w-0"
            label="материалы"
            swatches
            src={media.fabric}
            alt="Фактура матраса"
          ...
          <StatTile
            className="min-h-[210px] min-w-[72vw] snap-start md:min-w-[38vw] xl:col-span-4 xl:row-span-2 xl:col-start-9 xl:row-start-4 xl:min-h-0 xl:min-w-0"
            number="5"
            title="шагов заказа"
          ...
          <article className="relative isolate grid min-h-[390px] min-w-[86vw] snap-start overflow-hidden rounded-[18px] p-5 text-white md:min-w-[52vw] md:p-8 xl:col-span-8 xl:row-span-4 xl:col-start-1 xl:row-start-6 xl:min-h-0 xl:min-w-0 [&_*]:!text-white">
            ...
            <div className="flex h-full flex-col justify-between gap-8">
              ...
              <div className="max-w-[650px]">
                <h3 className="m-0 text-[clamp(29px,4.6vw,64px)] font-black leading-[0.98]">
          ...
          <ImageTile
            className="min-h-[210px] min-w-[72vw] snap-start md:min-w-[38vw] xl:col-span-2 xl:row-span-2 xl:col-start-9 xl:row-start-6 xl:min-h-0 xl:min-w-0"
            label="консультация"
            src={media.doctor}
            alt="Консультация"
          />
          ...
          <VideoTile
            className="min-h-[210px] min-w-[72vw] snap-start md:min-w-[38vw] xl:col-span-2 xl:row-span-2 xl:col-start-11 xl:row-start-6 xl:min-h-0 xl:min-w-0"
            label="проверка"
            poster={media.sofa}
            src={textileVideo}
            videoFirst
          ...
          <StatTile
            className="min-h-[210px] min-w-[72vw] snap-start md:min-w-[38vw] xl:col-span-4 xl:row-span-2 xl:col-start-9 xl:row-start-8 xl:min-h-0 xl:min-w-0"
            number="0 ₽"
            title="подбор"
...
function StatTile({
  ...
  return (
    ...
    >
      ...
      <p className="m-0 mt-5 max-w-[240px] text-[14px] leading-[1.24] text-[#5f6872] md:mt-8">
        {text}
      </p>
    </article>
  );
